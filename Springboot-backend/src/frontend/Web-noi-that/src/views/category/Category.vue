            ...
            <div class="row">
                            ...
                            <div class="ls_ul">
                                <div class="ls_list">
                                    <label v-for="(category,index) in productCategories" :key="index" class="box_checkbox">
                                        <input v-model="categoriesCheck[index]" @click="clickCheck(index,category.productCategoryId)" style="width:20px;height:20px" type="checkbox" name="category" :value="category.productCategoryId">
                ...
                <div class="col-lg-9">
                    ...
                    <form action="" method="POST" class="frm_filter wow fadeInUp d-lg-block d-none" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-xl-6 mb-md-0 mb-3">
                                <span class="title me-3">Sắp xếp theo: </span>
                                <a-select
                                    show-search
                    ...
                    <div class="row row-cols-xxl-5 row-cols-md-5 row-cols-2 mt-lg-5 pt-lg-2 mt-3 gx-0" v-if="products">
                        <div class="col" v-for="(product,index) in products" :key="index">
                            <div class="sale-prd__item h-100 wow fadeInUp">
                                ...
                                <a href="" class="_link d-block mb-sm-2 mb-1 mt-lg-4 mt-md-3 mt-2" title="">{{ product.productName }}</a>
                    ...
                    <div class="h-pagination">
                        <Pagination ref="pagination" @getData="getDataProduct" :totalRecord="params.TotalRecord" :pageSize="params.PageSize" :totalPages="params.TotalPages" :pageIndex="params.PageIndex" :filter="params.Filter" :textTotal="'sản phẩm'" />
                    </div>
                </div>
            </div>
        </div>
