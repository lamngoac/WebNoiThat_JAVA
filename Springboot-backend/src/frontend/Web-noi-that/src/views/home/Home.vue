                ...
                <swiper loop :autoplay= 5000 :pagination-clickable="true" :tab-mode-animation="true"> 
                    <div class="swiper-slide" v-for="index in 5" :key="index">
                        <div class="box_slide text-center">
                            ...
                            <a href="#" :title="$t('i18nHome.BuyNow' )" class="slide_now d-inline-block smooth btn_all wow fadeInUp">{{ $t('i18nHome.BuyNow' )}}</a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div  v-for="(data,index) in projectsHome" :key="index" class="col-md-6 col-12 mb-lg-4 mb-3">
                    <div class="item_project wow pulse" :data-wow-delay="`${index*0.1}`+'s'" data-wow-duration="2.5s">
                        <div class="img">
            ...
            <div class="row">
                <div v-for="(data,index) in newsHome" :key="index" class="col-lg-4 col-md-6 col-12 wow fadeInUp" :data-wow-delay="`${index*0.2}`+'s'" data-wow-duration="1.5s">
                    <div class="news__item">
                        <a class="news__item__img mb-lg-3 mb-sm-2 mb-2 d-block" href="" title="">
                            <img :src="require('@/assets/content/images/' + data.linkImage)" alt="" class="img-fluid">
                        </a>
                        ...
                        <a href="" class="news__item__title  d-block mb-lg-3 mb-sm-2 mb-2">{{ data.newsTitle }}</a>
