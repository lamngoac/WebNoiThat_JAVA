                ...
                <div>
                    <div class="h-row h-display-flex h-mg-t10">
                        <div class="h-col h-flex">
                            <Input :title="'Tiều đề tuyển dụng'" placeholder="Tiều đề tuyển dụng" v-model="recruitment.recruitmentTitle" />
                        </div>
                    </div>
                     <div class="h-row h-display-flex">
                        <div class="h-col h-flex">
                            <Textarea :title="'Nội dung tuyển dụng'" placeholder="Nội dung tuyển dụng"  v-model="recruitment.recruitmentContent"/>
                        </div>
                    </div>
                     <div class="h-row h-display-flex">
                        <div class="h-col h-flex">
                            <InputFile :title="'Ảnh tuyển dụng'" :name="recruitment.linkImage" ref="inputFile"/>
                        </div>
                    </div>
                </div>
            </template>
    ...
    export default {
        ...
        methods:{
            ...
            async saveRecruitment(){
                ...
                me.recruitment.linkImage = commonFunc.convertImgSaveDB(me.$refs.inputFile.fileName);
                // Thêm
                if(me.mode == "add"){
