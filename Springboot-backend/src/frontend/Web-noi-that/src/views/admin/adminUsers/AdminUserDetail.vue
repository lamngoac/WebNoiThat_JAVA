<template>
    <div class="h-popup" v-if="isShow">
        <popup @closePopup="closePopup" :width="600" :height="450">
                ...
                <div>
                    <div class="h-row h-display-flex h-mg-t10">
                        <div class="h-col h-flex">
                            <Input ref="firstInput" :title="'Tài khoản'" placeholder="Tài khoản" v-model="user.userName"/>
                        </div>
                        <div class="h-col h-flex ml-10">
                            <Input :title="'Mật khẩu'" placeholder="Mật khẩu" v-model="user.password"/>
                        </div>
                    </div>
                     <div class="h-row h-display-flex">
                        <div class="h-col h-flex">
                            <Input :title="'Họ và tên'" placeholder="Họ và tên" v-model="user.fullName"/>
                        </div>
                        <div class="h-col h-flex ml-10">
                            <Input :title="'Địa chỉ'" placeholder="Địa chỉ" v-model="user.address"/>
                        </div>
                    </div>
                     <div class="h-row h-display-flex">
                        <div class="h-col h-flex">
                            <Input :title="'Số điện thoại'" placeholder="Số điện thoại" v-model="user.phoneNumber"/>
                        </div>
                    </div>
                </div>
            </template>
